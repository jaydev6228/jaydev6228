...
`MVVM` `MVC` `Core Data` `REST APIs` `Combine`
...
- 📱 **Rakuten Group** — Leading iOS for Rakuten Kakeibo (personal finance app, millions of users)
- 🏢 **VeBuIn 株式会社** — Led 8-member cross-functional team; reduced crashes by 20%, API response 8s → 2s
- ✈️ **ThinkBiz / WebPixel** — Shipped apps with 50k+ downloads, 4.5★ App Store rating
- 🏠 **SMN Digital** — Built IoT & Smart Home apps across healthcare and education
...
- **Kotlin** & **Jetpack Compose** — bringing my iOS architecture mindset to Android
- **JLPT N3** Japanese — working and living in Japan since 2020
...
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:jaydevbaloliya@gmail.com)
